import getRecords from '../src/app/actions/getRecords';
import RecordCard from './RecordCard';
import { Record } from '../types/Record';

//cards for expense history
const RecordHistory = async () => {
  ...
  if (!records || records.length === 0) { //if there are no records/expenses
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
        ...
        <div className='text-center py-6 sm:py-8'>
          ...
          <p className='text-gray-600 dark:text-gray-400 max-w-md mx-auto text-sm'>
            Track your spending to uncover patterns and build a clearer financial picture.
          </p>
        </div>
      </div>
    );
