        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
          ...
          <div className='text-center md:text-left'>
            <div className='inline-flex items-center gap-2 mb-4'>
              ...
              <h2 className='text-xl font-bold bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-500 bg-clip-text text-transparent'>
                PocketPilot AI
              </h2>
            </div>
            <p className='text-gray-600 dark:text-gray-400 leading-relaxed max-w-sm'>
              Smart financial management with AI. Monitor your expenses, control your budget, and uncover insights about your spending habits
            </p>
          </div>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          <div className='text-center md:text-left mb-4 md:mb-0'>
            <p className='text-gray-500 dark:text-gray-400 text-sm'>
              © {new Date().getFullYear()} PocketPilot. All rights
              reserved.
            </p>
          </div>
